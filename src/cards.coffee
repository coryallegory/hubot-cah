...
module.exports.random_question = () ->
  card_index = Math.floor(Math.random()*questions.length)
  return card_index

module.exports.random_answer = () ->
  card_index = Math.floor(Math.random()*answers.length)
  return card_index
